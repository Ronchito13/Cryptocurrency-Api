...
function chooseAbout() {
  $("#aboutUs").click(function() {
    $("#about").empty();
    let bodyText =
      "<div class='ronAbout half left'><p class='description'><u>About Ron</u></p><br><p>Hi! My name is Ron. I’m 31 years old and I live in Petah Tikva, Israel. I work as a webmaster and as a marketing expert. I've been involved in network marketing in various companies and verticals for the last 3 years. Skills to work effectively with people of different nationals and cultural backgrounds, motivating individuals and groups. As of today i'm also a studant for web developing at John bryce college</p><br><p class='description'><u>About the project</u></p><br><p>project number 3 in our full stack course. in this project, you will receive live rates of cryptocurrency coins using restfull api with jquery. hope you will enjoy my project :)</p></div></div><div class='half left ronImage'><img style='border: 2px solid black;' src='/assets/images/ron.jpg'></div></div>";
...
async function displayReports() {
  ...
  if (reportsSymbol === null) {
    $("#chartContainer").append(
      "<p class='description'>You didn't choose any coins for the reports yet....</p><br><div class='center'><img src='assets/images/emoji.png' width='200px;'></div>"
    );
  } else {
